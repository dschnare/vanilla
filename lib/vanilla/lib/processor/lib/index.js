...
exports.replace = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = vanilla.readDirective('replace', prefix, suffix, file.content);
...
exports.append = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = vanilla.readDirective('append', prefix, suffix, file.content);
...
exports.prepend = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = vanilla.readDirective('prepend', prefix, suffix, file.content);
