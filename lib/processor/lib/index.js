...
exports.interpolation = function (phase) {
  return {
    ...
    name: 'interpolation',
    process: function (file, options, helpers, callback) {
      file.content = HOGAN.compile(file.content).render(options.data ? helpers.extend({}, options.data, file.data) : file.data || {}, options.partials ? helpers.extend({}, options.partials, file.partials) : file.partials || {});
      callback(null, file);
    }
  };
};