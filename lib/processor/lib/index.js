    ...
    process: function (file, options, helpers, callback) {
      ...
      function execute(fromIndex) {
        ...
        if (directive.open.empty) {
          ...
          file.content = file.content.substring(0, directive.open.end) + body + file.content.substring(end);
...
exports.replace = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = helpers.readDirective('replace', prefix, suffix, file.content);
...
exports.append = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = helpers.readDirective('append', prefix, suffix, file.content);
...
exports.prepend = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = helpers.readDirective('prepend', prefix, suffix, file.content);
...
exports.extend = function (phase) {
  return {
    ...
    process: function (file, options, helpers, callback) {
      ...
      directive = helpers.readDirective('extend', prefix, suffix, file.content);
